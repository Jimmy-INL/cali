...
def basic_abc(model, data, epsilon=1, min_samples=10,
    ...
    """
    posterior, rejected, distances, synthetic_data_set = [], [], [], []
    ...
    while accepted_count < min_samples:
        ...
        if distance < epsilon:
            ...
            synthetic_data_set.append(synthetic_data)
    ...
    return (posterior, distances,
            ...
            epsilon, weights, tau_squared, eff_sample, synthetic_data_set)
    ...
    if len(theta.shape) == 1:
        ...
        for i in range(theta.shape[1]):
            ...
            for j in range(theta_prev.shape[1]):
                b = (tau_squared - np.min(tau_squared)) / np.ptp(tau_squared)
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def pseudo_marginal_abc(model, data, epsilon=1, min_samples=10,
              parallel=False, n_procs='all', pmc_mode=False,
              weights='None', theta_prev='None', tau_squared='None'):
    pass
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def synthetic_likelihood_abc(model, data, epsilon=1, min_samples=10,
                        parallel=False, n_procs='all', pmc_mode=False,
                        weights='None', theta_prev='None', tau_squared='None'):
    pass
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def adaptive_synthetic_likelihood_abc(model, data, epsilon=1, min_samples=10,
                        parallel=False, n_procs='all', pmc_mode=False,
                        weights='None', theta_prev='None', tau_squared='None'):
    pass
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def kde_likelihood_abc(model, data, epsilon=1, min_samples=10,
                        parallel=False, n_procs='all', pmc_mode=False,
                        weights='None', theta_prev='None', tau_squared='None'):
    pass
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def adaptive_kde_likelihood_abc(model, data, epsilon=1, min_samples=10,
                        parallel=False, n_procs='all', pmc_mode=False,
                        weights='None', theta_prev='None', tau_squared='None'):
    pass
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def projected_synthetic_surrogate_abc(model, data, epsilon=1, min_samples=10,
                        parallel=False, n_procs='all', pmc_mode=False,
                        weights='None', theta_prev='None', tau_squared='None'):
    pass
...
# TODO see https://github.com/Neojume/pythonABC for inspiration
def projected_kde_surrogate_abc(model, data, epsilon=1, min_samples=10,
                        parallel=False, n_procs='all', pmc_mode=False,
                        weights='None', theta_prev='None', tau_squared='None'):
    pass
